...
export const ServicesIllustrationDesign = () => {
    const walkAwayWith = [
  ...
  <div className="text-center text-white mb-[3rem] bg-white "> 
                ...
                <div className=" bg-[url(././assets/services/twoBoxes.png)] bg-no-repeat bg-cover  max-sm:!pb-[3rem]  h-fit !overflow-hidden relative   bg-center ">
                    ...
                    <NavBar/>
                    <div className="illustrationDesign-topBlur "/>
                    <div className=" flex flex-col md:px-[4rem] px-[2rem] box-border md:py-[5rem] py-[2rem]  w-full rtl:text-right "> 
                        ...
                        {formatT(["illustrationDesign.header.title"])}
                            <div className="paragraphText max-sm:font-light font-extralight mt-[1rem] font-[Poppins] rtl:!text-right">
                        {formatT(["illustrationDesign.header.description"])}
                        </div>
                        </div>

                        <div className="md:py-[1rem] md:m-0 mt-4  m-auto flex sm:flex-row  gap-2  md:gap-3 rtl:!text-right">
                            <Button className="primaryButton md:!text-inherit !text-[14px] sm:w-fit">{formatT(["illustrationDesign.header.buttons.startProject"])}</Button>
                            <Button className="secondaryButton md:!text-inherit !text-[14px] sm:w-fit">{formatT(["illustrationDesign.header.buttons.freeConsultation"])}</Button>
                        </div> 
                ...
                <div className=" bg-white text-black flex flex-col  max-sm:!py-[3rem] max-sm:!px-[2rem]  md:px-[4rem]  w-full box-borde gap4 !px-[2rem] !py-[2rem] md:!py-[6rem]  justify-center items-center "> 
                    ...
                    {formatT(["illustrationDesign.intro.text1"])}     
                    {formatT(["illustrationDesign.intro.text2"])}                     
                ...
                <div className=" bg-[#FFF9F2] text-black max-sm:!py-[3rem] max-sm:!pb-[3rem]  max-sm:!px-[2rem] flex flex-col md:!px-[4rem] gap-2 !px-[2rem] !py-[2rem]  w-full  md:!py-[6rem] justify-center items-center ">
                    <span className="font-medium md:text-[16px] text-[20px] ">{formatT(["illustrationDesign.whatIncluded.subtitle"])}     </span>
                    <div className="w-[100%] font-medium lg:w-[40%]  md:w-[60%]  justify-between text-center md:text-[40px] text-[28px]  font-[Tektur]">
                            {formatT(["illustrationDesign.whatIncluded.headline"])}     
                    </div>
                    <span className="text-[#FF8200] w-[100%] font-normal lg:w-[40%]  md:w-[60%]  text-[20px]  font-[Poppins]">
                            {formatT(["illustrationDesign.whatIncluded.note"])}     
                        </span>
                ...
                <div className="  max-sm:!py-[3rem] max-sm:!px-[2rem]  bg-white font-medium text-black flex flex-col md:!px-[4rem] gap-2 !px-[2rem] w-full  md:!py-[6rem]  justify-center items-center ">
                    <span className="md:text-[20px] text-[16px]">{formatT(["illustrationDesign.whoThisFor.subtitle"])}</span>
...
{formatT(["illustrationDesign.whoThisFor.headline"])}                   </div>
                    ...
                    <Grid container fontWeight={500} fontSize={'16px'} mt={2}  spacing={4} >
                        ...
                        <div className="h-[25rem] mb-3 overflow-hidden rounded-lg  ">
                            ...
                            {formatT(["illustrationDesign.whoThisFor.audienceGrid.items.0.text"])} 
                        </Grid>
                        ...
                        <div>
                            {formatT(["illustrationDesign.whoThisFor.audienceGrid.items.1.text"])} 
                        </div>
                        </Grid>
                        <Grid size={{md:6, "sm":12, "xs":12}}>
                                                    <div className="h-[25rem] mb-3 overflow-hidden rounded-lg  ">
                        ...
                        <img src={img1} className="h-[25rem] w-full  mb-3 object-cover rounded-lg imageZoomIn"/>
                            ...
                            {formatT(["illustrationDesign.whoThisFor.audienceGrid.items.2.text"])} 
                        </Grid>
                        <Grid size={{md:6, "sm":12, "xs":12}}>
                                                                                <div className="h-[25rem] mb-3 overflow-hidden rounded-lg  ">
                        ...
                        <img src={img4} className="h-[25rem] w-full mb-3 object-cover rounded-lg imageZoomIn"/>
                            ...
                            {formatT(["illustrationDesign.whoThisFor.audienceGrid.items.3.text"])} 
                        </Grid>
                    </Grid>
                ...
                <div className=" bg-[#FFF9F2]  text-black flex flex-col md:!px-[4rem] gap-2 !px-[2rem] w-full box-border md:!py-[6rem] justify-center items-center max-sm:!py-[3rem] max-sm:!px-[2rem]  ">
                    ...
                    <span className="font-[Poppins] md:text-[20px] font-medium text-[16px]">{formatT(["illustrationDesign.walkAwayWith.title"])}</span>
                        <span className="text-[#FF8200] w-[100%] font-medium lg:w-[100%] md:w-[90%] md:text-[40px] text-[28px] ">
                            {formatT(["illustrationDesign.walkAwayWith.heading"])} 
                        ...
                        {walkAwayWith.map((data, ind) => {
                            return (
                                <EnterFromBottomAnimate>
                                    ...
                                    {formatT([`illustrationDesign.walkAwayWith.items.${ind}`])}
                                </Stack>
                                </EnterFromBottomAnimate>
                ...
                <div className="whyHeroesHive font-[Tektur]  mx-auto">
                        <div className="font-medium  md:text-[40px] w-full text-[28px]   sm:font-semibold md:max-w-[30rem]">
                            {formatT(["illustrationDesign.whyHeroes.title"])}
                            </div>
                        ...
                        <Stack direction={"column"} justifyContent={"center"} alignItems={"center"}  gap={2}  className="w-full sm:max-w-[20rem]">
                            ...
                            <div className="sm:text-[20px] text-[16px] font-semibold  font-[Tektur]">{formatT(["illustrationDesign.whyHeroes.features.workflow.headline"])}</div>
                            <div className="paragraphText">{formatT(["illustrationDesign.whyHeroes.features.workflow.description"])}</div>
                        ...
                        <Stack direction={"column"} justifyContent={"center"} alignItems={"center"}  gap={2} className="w-full sm:max-w-[20rem]">
                            <div className="bg-[#FFDFBC] !text-[#FF8200] w-[3rem] h-[3rem] rounded-lg flex flex-col justify-center items-center">
                             ...
                             <div className="sm:text-[20px] text-[16px] font-semibold  font-[Tektur]">{formatT(["illustrationDesign.whyHeroes.features.squads.headline"])}</div>
                            <div className="paragraphText">{formatT(["illustrationDesign.whyHeroes.features.squads.description"])}</div>
                        </Stack>
                                    </SpringAnimate>
                        ...
                        <Stack direction={"column"} justifyContent={"center"} alignItems={"center"}  gap={2}  className="!w-full sm:max-w-[20rem]">
                            <div className="bg-[#FFDFBC] !text-[#FF8200] w-[3rem] h-[3rem] rounded-lg flex flex-col justify-center items-center">
                             ...
                             <div className="sm:text-[20px] text-[16px] font-semibold  font-[Tektur]">{formatT(["illustrationDesign.whyHeroes.features.managers.headline"])}</div>
                            <div className="paragraphText">{formatT(["illustrationDesign.whyHeroes.features.managers.description"])}</div>             
                        </Stack>           
                        </SpringAnimate>
            ...
            <Stack direction={"column"} justifyContent={"center"} alignItems={"center"}  gap={2}   className="w-full sm:max-w-[20rem]">
                            <div className="bg-[#FFDFBC] !text-[#FF8200] w-[3rem] h-[3rem] rounded-lg flex flex-col justify-center items-center ">
                             ...
                             <div className="sm:text-[20px] text-[16px] font-semibold   font-[Tektur]">{formatT(["illustrationDesign.whyHeroes.features.revisions.headline"])}</div>
                            <div className="paragraphText">{formatT(["illustrationDesign.whyHeroes.features.revisions.description"])}</div>
                        ...
                        <Stack direction={"column"} justifyContent={"center"} alignItems={"center"}  gap={2}  className="!w-full sm:max-w-[20rem]">
                            <div className="bg-[#FFDFBC] !text-[#FF8200] w-[3rem] h-[3rem] rounded-lg flex flex-col justify-center items-center">
                             ...
                             <div className="sm:text-[20px] text-[16px] font-semibold  !w-full font-[Tektur]">{formatT(["illustrationDesign.whyHeroes.features.payment.headline"])}</div>
                            <div className="paragraphText">{formatT(["illustrationDesign.whyHeroes.features.payment.description"])}</div>
                        ...
                        <Stack direction={"column"} justifyContent={"center"} alignItems={"center"}  gap={2}  className="w-full sm:max-w-[20rem]">
                            <div className="bg-[#FFDFBC] !text-[#FF8200] w-[3rem] h-[3rem] rounded-lg flex  flex-col justify-center items-center">
                             ...
                             <div className="sm:text-[20px] text-[16px] font-semibold  font-[Tektur]">{formatT(["illustrationDesign.whyHeroes.features.security.headline"])}</div>
                            <div className="paragraphText">{formatT(["illustrationDesign.whyHeroes.features.security.description"])}</div>
                        ...
                        <Button className="!text-white watchVideoBtn  !px-4 !py-2 !rounded-[100px] secondaryButton ">{formatT(["illustrationDesign.whyHeroes.learnMore"])}</Button>
                        </Stack>
                ...
                <div className="  bg-[#FFF9F2] font-medium  flex flex-col gap-2 md:px-[4rem] max-sm:!py-[3rem] max-sm:!px-[2rem] rtl:text-right  px-[2rem] w-full box-border  py-[4rem]  text-left justify-center ">
                    <span className=" text-left text-black md:text-[20px] text-[16px]  rtl:text-right">{formatT(["illustrationDesign.ourWork.subtitle"])}</span>
                    ...
                    <span className="text-black  rtl:text-right">{formatT(["illustrationDesign.ourWork.headline"])}</span>  

                    <Button  className="secondaryButton !text-white md:!text-inherit w-fit !h-fit !text-[14px] md:!block !hidden">{formatT(["illustrationDesign.ourWork.seeMoreButton"])}</Button>           
                    </div>
                    ...
                    <Grid container fontWeight={500} fontSize={'16px'} mt={2}  spacing={4} color={"black"} >
                        ...
                        <img src={imgA} className="h-[35rem]  w-full object-cover rounded-lg mb-3 imageZoomIn"/>
                           ...
                           {formatT(["illustrationDesign.ourWork.projects.0"])}                      
                        </Grid>
                ...
                <div className="flex md:flex-row flex-col w-full   md:pl-[4rem] box-border bg-[#FF8200]  justify-between items-center ">
                    <div className=" md:py-[8rem] py-[4rem] p-[2rem] w-full">
                        <div className=" text-semibold text-[40px] max-sm:text-[25px] text-left md:text-center w-full font-[Tektur] font-medium ">
                            {formatT(["illustrationDesign.growSection.title"])}                      
                        </div>  
                        <div className=" text-semibold text-[20px] text-left  md:text-center w-full  ">
                            {formatT(["illustrationDesign.growSection.subtitle"])}     
                            </div>                 
                    <div className="md:py-[1rem] w-full m-auto flex md:flex-row mt-5 justify-center items-center align-center gap-3">
                        <Button className="startAProjectButton md:!text-inherit w-fit ">{formatT(["illustrationDesign.growSection.buttons.startProject"])}</Button>
                        <Button className="secondaryButton md:!text-inherit w-fit ">{formatT(["illustrationDesign.growSection.buttons.freeConsultation"])}</Button>
                    </div>            
                    </div>
